...
struct Ardrone3PilotingStatemoveToChanged_
{
  ...
  _status_type status;
    ...
    enum { orientation_mode_NONE = 0u };
     enum { orientation_mode_TO_TARGET = 1u };
     enum { orientation_mode_HEADING_START = 2u };
     enum { orientation_mode_HEADING_DURING = 3u };
     enum { status_RUNNING = 0u };
     enum { status_DONE = 1u };
     enum { status_CANCELED = 2u };
     enum { status_ERROR = 3u };
