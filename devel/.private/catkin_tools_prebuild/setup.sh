...
: ${_CATKIN_SETUP_DIR:=/home/chahatdeep/bebop_ws/devel/.private/catkin_tools_prebuild}
=======

# since this file is sourced either use the provided _CATKIN_SETUP_DIR
# or fall back to the destination set at configure time
: ${_CATKIN_SETUP_DIR:=/home/dronelaptop/bebop_ws/devel/.private/catkin_tools_prebuild}
