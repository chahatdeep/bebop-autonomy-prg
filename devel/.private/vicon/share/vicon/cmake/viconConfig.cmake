...
if("TRUE" STREQUAL "TRUE")
  set(vicon_SOURCE_PREFIX /home/dronelaptop/bebop_ws/src/vicon/vicon)
  set(vicon_DEVEL_PREFIX /home/dronelaptop/bebop_ws/devel/.private/vicon)
  set(vicon_INSTALL_PREFIX "")
  set(vicon_PREFIX ${vicon_DEVEL_PREFIX})
else()
  set(vicon_SOURCE_PREFIX "")
  set(vicon_DEVEL_PREFIX "")
  set(vicon_INSTALL_PREFIX /home/dronelaptop/bebop_ws/install)
...
if(NOT "/home/dronelaptop/bebop_ws/devel/.private/vicon/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  set(vicon_INCLUDE_DIRS "")
  set(_include_dirs "/home/dronelaptop/bebop_ws/devel/.private/vicon/include;/usr/include/eigen3;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vicon' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dronelaptop/bebop_ws/src/vicon/vicon/${idir}'.  Ask the maintainer 'Kartik Mohta <kmohta@seas.upenn.edu>, Chao Qu <quchao@seas.upenn.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/dronelaptop/bebop_ws/devel/.private/vicon/lib;/home/dronelaptop/bebop_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(vicon_EXPORTED_TARGETS "vicon_generate_messages_cpp;vicon_generate_messages_eus;vicon_generate_messages_lisp;vicon_generate_messages_nodejs;vicon_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vicon_dep}_FOUND)
      find_package(${vicon_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vicon_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
