...
(cl:defmethod cl:initialize-instance :after ((m <Marker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Marker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon-msg:<Marker> is deprecated: use vicon-msg:Marker instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Marker>))
...
(cl:defmethod subject_name-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon-msg:subject_name-val is deprecated.  Use vicon-msg:subject_name instead.")
  (subject_name m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Marker>)))
  ...
  "a16c57ea269b234761b832931693cc90")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Marker)))
  "Returns md5sum for a message object of type 'Marker"
  "a16c57ea269b234761b832931693cc90")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Marker>)))
  ...
  (cl:format cl:nil "string name~%string subject_name~%geometry_msgs/Point position~%bool occluded~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Marker)))
  "Returns full string definition for message of type 'Marker"
  (cl:format cl:nil "string name~%string subject_name~%geometry_msgs/Point position~%bool occluded~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
