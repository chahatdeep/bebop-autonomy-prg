...
(cl:defclass <Subject> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector vicon-msg:Marker)
   :initform (cl:make-array 0 :element-type 'vicon-msg:Marker :initial-element (cl:make-instance 'vicon-msg:Marker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Subject>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Subject)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon-msg:<Subject> is deprecated: use vicon-msg:Subject instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Subject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon-msg:header-val is deprecated.  Use vicon-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Subject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon-msg:name-val is deprecated.  Use vicon-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'occluded-val :lambda-list '(m))
(cl:defmethod occluded-val ((m <Subject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon-msg:occluded-val is deprecated.  Use vicon-msg:occluded instead.")
  (occluded m))
...
(cl:defmethod orientation-val ((m <Subject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon-msg:orientation-val is deprecated.  Use vicon-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'markers-val :lambda-list '(m))
(cl:defmethod markers-val ((m <Subject>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon-msg:markers-val is deprecated.  Use vicon-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Subject>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vicon-msg:Marker))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Subject>)))
  ...
  (cl:format cl:nil "Header header~%string name~%bool occluded~%geometry_msgs/Point position~%geometry_msgs/Quaternion orientation~%vicon/Marker[] markers~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: vicon/Marker~%string name~%string subject_name~%geometry_msgs/Point position~%bool occluded~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Subject)))
  "Returns full string definition for message of type 'Subject"
  (cl:format cl:nil "Header header~%string name~%bool occluded~%geometry_msgs/Point position~%geometry_msgs/Quaternion orientation~%vicon/Marker[] markers~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: vicon/Marker~%string name~%string subject_name~%geometry_msgs/Point position~%bool occluded~%~%~%"))
